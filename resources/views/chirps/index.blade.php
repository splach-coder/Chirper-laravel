<x-app-layout>
    ...
    <div class="mt-6 max-w-2xl mx-auto shadow-sm rounded-lg divide-y">
        @foreach ($chirps as $chirp)
        <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 flex space-x-2 bg-white" style="margin-bottom: 20px;">
